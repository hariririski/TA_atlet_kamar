    ...
    <?php
                  ...
                  while($data = mysqli_fetch_array($sql))
                   ...
                   <tr>
					...
					echo "
					<td><a href='detailatlet.php?no_database_atlet=".$data['no_database_atlet']."'   onclick=\"return confirm('Apakah Anda ingin Melihat Data Ini?') \"     >
					<center><button type='button' class='btn btn-info'>Detail</button></center></a></td>";
										echo "
					<td><a href='proses/proseshapusatlet.php?no_database_atlet=".$data['no_database_atlet']."'   onclick=\"return confirm('Apakah Anda ingin Melihat Menghapus Data Ini?')\"      >
