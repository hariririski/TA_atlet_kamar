              ...
              <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <form role="form" action="proses/prosestambahagama.php" method="post">
               <h3> Tambah Agama </h3>
		<label> Agama </label>
		<input name="nama_agama" type="text" class="form-control" placeholder="Text input" required> 
		<br> 
 ...
 <br>
    ...
    <?php
                  ...
                  while($data = mysqli_fetch_array($sql))
                   ...
                   <tr>
                    <td width="30px">'.$i.'</td>
                    <td class="center">'.$data['nama_agama'].'</td>
                    ';
					echo "
					<td><a href='edit_agama.php?kode_agama=".$data['id_agama']."'  data-toggle='modal' data-target='#myModal'    >
					<center><button type='button' class='btn btn-warning'>Edit</button></center></a></td>";
					echo "
					<td><a href='proses/proseshapusagama.php?id_agama=".$data['id_agama']."'   onclick=\"return confirm('Apakah Anda ingin Melihat Data Ini?') \" title='Detail Agama'     >
