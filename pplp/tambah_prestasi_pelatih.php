...
<div class="modal-content">
		...
		<form role="form" action="proses/proses_tambah_prestasi_pelatih.php?id=<?php echo $no_database_pelatih ?>" method="post" enctype="multipart/form-data">
	 <label >Nama Prestasi</label>
    <input name="nama_prestasi" type="text" class="form-control" id="exampleInputEmail1"  placeholder="Event" />
