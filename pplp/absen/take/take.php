        ...
        function my_completion_handler(msg) {
            ...
            if (msg.match(/(http\:\/\/\S+)/)) {
                ...
                document.getElementById('upload_results').innerHTML = 
                    ...
                    '<a href="../../proses/proses_absen_siswa.php?id='+image_url+'&&id2=<?php echo$id2;?>" target"_blank"><input type="button" class="snap" value="Upload" ></a>';
    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
              ...
              $tampil = "select * from atlet where no_database_atlet='$no_database_atlet'";
